  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white/50 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
        ...
        {submitted ? (
          <div className="bg-emerald-50 border border-emerald-100 text-emerald-800 p-5 rounded-2xl mb-8 flex flex-col gap-2">
            <span className="font-medium">Request Sent!</span>
            <span className="text-sm text-emerald-700/95 font-light">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200/50 text-center">
          <p className="text-sm text-gray-500 font-light">
            ...
            <Link to="/auth?mode=login" className="text-blue-600 hover:text-blue-700 font-normal">
              Sign in
            </Link>
          </p>
        </div>
