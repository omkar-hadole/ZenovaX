    ...
    return (
        <div className="p-4 sm:p-8 max-w-7xl mx-auto">
            ...
            {loading ? (
                        ...
                        {currentMentors.map((mentor) => (
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    <div className="w-24 h-24 rounded-2xl overflow-hidden mb-4 shadow-lg ring-4 ring-gray-50 dark:ring-gray-800 group-hover:ring-indigo-50 dark:group-hover:ring-indigo-500/20 transition-all">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{mentor.name}</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 font-medium mb-4 flex items-center gap-1.5">
                                    ...
                                    <button className="w-full py-3 rounded-xl bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-bold text-sm group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm hover:shadow-indigo-200 dark:hover:shadow-none">
                                        View Profile
                                    </button>
                                </div>
                            </div>
                ...
                <div className="text-center py-20 bg-white dark:bg-gray-900 rounded-[2rem] border border-dashed border-gray-200 dark:border-gray-700">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-1">No mentors found</h3>
