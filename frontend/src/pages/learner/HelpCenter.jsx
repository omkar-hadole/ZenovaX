        ...
        <div className="p-4 sm:p-6 mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="relative mb-6 text-left">
                    ...
                    <p className="text-slate-600 dark:text-gray-400 max-w-xl">
                        Get instant answers or connect with our team — we're just a tap away.
                    </p>
            </header>
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-white/85 text-sm sm:text-base leading-relaxed max-w-md">
                                Get instant help from our team — we're online and ready to assist you directly.
                            </p>
                    ...
                    <div className="relative">
                        ...
                        <ul className="space-y-4 text-sm text-white/85">
                            <li className="flex items-start gap-3">
                                ...
                                <span>For instant AI assistance, try asking <strong className="text-white">Zen</strong> in the sidebar — it's faster!</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="w-5 h-5 mt-0.5 rounded-full bg-white/25 text-white flex items-center justify-center flex-shrink-0">
                                    <Sparkles className="w-3 h-3" />
